...
public class EventMapper {
    ...
    public EventEntity toEntity(Event event) {
        return new EventEntity(
            ...
            event.getEventDate().value(),
            event.getLocation() != null ? event.getLocation().venue() : "TBD",
            event.getLocation() != null ? event.getLocation().city() : "TBD",
            event.getLocation() != null ? event.getLocation().country() : "TBD",
    ...
    public Event toDomain(EventEntity entity) {
        return Event.reconstruct(
            ...
            new EventDate(entity.getEventDate()),
            new Location(entity.getLocationVenue(), entity.getLocationCity(), entity.getLocationCountry()),
